...
class estateWizard(models.TransientModel):
    ...
    _description='This is to demonstrate Wizards In odoo'
    
    partner1_id = fields.Many2one("res.partner", "Partner", required=True)
...
class estateOffer(models.TransientModel):
    ...
    _description='hi this is the class of Wizard'
